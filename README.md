...
🔗 https://attendence-tracker-kartik.vercel.app/  

A backend-driven attendance management system designed to track user activity, working hours, and maintain structured records through APIs and dashboard integration.

**Key Features:**  
- User attendance tracking  
- Time logs & working hours calculation  
...
### ❤️ HeartGuard Health App  
🔗 https://heartguard-app-app.streamlit.app/  

A data-driven health application that predicts heart-related risks using machine learning models and interactive UI.
